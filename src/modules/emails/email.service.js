...
exports.fetchFromGmail = fetchFromGmail;
...
async function fetchFromGmail() {
    // get tokens
    const t = await db_1.client.query('SELECT access_token, refresh_token FROM oauth_tokens ORDER BY id DESC LIMIT 1');
    ...
    const oAuth2Client = new googleapis_1.google.auth.OAuth2(process.env.GOOGLE_CLIENT_ID, process.env.GOOGLE_CLIENT_SECRET, process.env.GMAIL_REDIRECT_URI);
    ...
    for (const m of list.data.messages) {
        ...
        const receivedAt = (0, common_1.parseDate)(date);
        ...
        await db_1.client.query(`INSERT INTO emails(gmail_id, thread_id, sender_email, to_recipients, cc_recipients, recipients, subject, body, is_unread, labels, received_at)
